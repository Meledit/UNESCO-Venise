...
<head>
    ...
    <link rel="stylesheet" href="styleArchitecture.css">
...
<?php
    ...
    $accrocheTexte = array("Venise est une ville regroupant des styles architecturaux de différentes époques sur cette page vous-y trouverez tout ce qui les concernes.",
    ...
    $carouImgTexte1 = array("Il fait partie des 4 grands ponts qui traverse 
    ...
    $carouImgTexte3 = array("La basilique cathédrale Saint Marc est la plus importante de Venise, 
    ...
    $style1Texte1 = array("Le style vénéto-byzantin est peu différent du style roman avec ses arcs en plein cintre (en demi-cercle). 
    ...
    $s1Article1Texte1 = array("Ces 2 palais, la Ca’ Loredan et Ca’ Farsetti à Venise, ont été construits au 13e siècle.
    ...
    $s1Article1Texte2 = array("Aujourd’hui, ces 2 palais abritent la mairie de Venise.",
    "Today, these 2 palaces house the town hall of Venice.");
    $s1Article1LegImg = array("A gauche la Ca' Loredan et à droite la Ca' Farsetti",
    "On the left the Ca' Loredan and on the right the Ca' Farsetti");
    $s1Article1Saviezvous = array("On les observe mieux depuis la rive opposée du Grand Canal, en franchissant le pont du Rialto tout proche.",
    "They are best seen from the opposite bank of the Grand Canal, crossing the nearby Rialto Bridge.");

    $style2Titre1 = array("ARCHITECTURE VÉNITIENNE ROMANE", 
    "ROMANESQUE VENETIAN ARCHITECTURE ");
    $style2Texte1 = array("Le style architectural roman est plus facilement observable à Venise dans les constructions religieuses que civiles. 
    ...
    $style2Texte2 = array("Dans l’habitation civile, les étages supérieurs accueillent les pièces à vivre, au-dessus du rez-de-chaussée qui sert d’entrepôt.
    ...
    $s2Article1Texte1 = array("La basilique est de forme octogonale pour évoquer une couronne dédiée à la Vierge.
    ...
    $s2Article1Texte2 = array("Placée en bordure du Grand Canal, elle repose sur plus d’un million de pilotis,
    pour supporter son poids !",
    "Placed on the edge of the Grand Canal, it rests on more than a million pilings,
    to support its weight!");
    $s2Article1Texte3 = array("Les façades sont richement décorées de statues de personnages, d’anges, des quatre évangélistes et
    ...
    $s2Article2Texte1 = array("Commencée au 7ème siècle, et achevée telle que nous la voyons aujourd’hui au 12ème.",
    "Started in the 7th century, and completed as we see it today in the 12th century.");
    $s2Article2Texte2 = array("The mosaic in the apse, the beautiful chevet (outer apse) and the mosaic paving, which is not only geometric but also has a number of other figures, are particularly noteworthy,
    ...
    $s2Article2Texte3 = array("Autre élément à noter qui caractérise cet édifice : le chevet de forme pentagonale et sa double
    ...
    $style3Texte1 = array("L’architecture gothique à Venise développe principalement des décorations raffinées, surabondantes sans être trop chargées.
    ...
    $s3Article1Texte1 = array("La Ca’ d’Oro est sans doute le palais le plus emblématique de Venise, après le Palais des Doges.",
    "The Ca' d'Oro is probably the most emblematic palace in Venice, after the Doge's Palace.");
    $s3Article1Texte2 =array("En 1412, Marino Contarini fait construire un palais, dont il espère qu’il surpassera en beauté tous
    ...
    $s3Article2Texte1 = array("Le Palais des Doges abritait les appartements du doge et les différents organes de la République.
    ...
    hosted.");
    $s3Article2SaviezVous = array("L’intérieur du palais fut décoré par les meilleurs peintres vénitiens, c’est ainsi qu’il est devenu un magnifique musée",
    ...
    $style4Texte1 = array("L’architecture Renaissance a donné naissance à des palais imposants, loin de la finesse de la future architecture gothique.
    ...
    $s4Article1Texte1 = array("Au Palais Grimani, on apprécie la galerie, la cour et l’escalier.
    ...
    Zuccari.");
    $s4Article1Texte2 = array("Malheureusement, le mobilier et autres richesses intérieures ont été dispersées.
    ...
    $s4Article1Texte3 = array("Ne pas confondre avec le Palazzo Grimani di San Luca.", 
    "Not to be confused with the Palazzo Grimani di San Luca.");
    $s4Article2Texte1 = array("Santa Maria dei Miracoli est relativement tassée sur elle-même,
    ...
    $s4Article2Texte2 = array("On en reste encore, au XVe siècle,
    ...
    $style5Texte1 = array("A la mort du dernier Pesaro, le palais fut acheté par divers propriétaires,
    ...
    $s5Article1Texte1 = array("A la mort du dernier Pesaro, le palais fut acheté par divers propriétaires,
    dont Felicita Bevilacqua La Masa, grande amatrice d’art.",
    "After the death of the last Pesaro, the palace was bought by various owners,
    including Felicita Bevilacqua La Masa, a great lover of art.");
    $s5Article1Texte2 = array("A la toute fin du XIXe siècle, celle-ci fit don de son palais à la ville de Venise,
    ...
    $recoTexte = array("Ces monuments ne sont absolument pas à rater si vous allez à Venise, une expérience que vous n'oublirez pas !",
    "These monuments are not to be missed if you go to Venice, an experience you won't forget!");

    $rialtoTexte1 = array("Le pont du Rialto est un des symboles de Venise. Pont le plus vieux et le plus connu de Venise, 
    ...
    $rialtoTexte2 = array("Le choix de construire ce pont en pierre et marbre d’Istrie dans ces zones marécageuses est une véritable prouesse architecturale. 
    ...
    $rialtoTexte3 = array("Le Pont du Rialto se compose de trois rampes d’escaliers pour piétons et d’une double rangée de boutiques ouverte vers le Grand Canal par six arches à la montée et six arches à descente. 
    ...
    $campanileTexte1 = array("Le campanile de Saint-Marc est une tour campanaire construite en 912 et reconstruite en 1914.
    ...
    $campanileTexte2 = array(" La tour, de 98,6 mètres de haut, se trouve seule dans un coin de la Place Saint-Marc, près de la façade de la basilique. 
    ...
    $campanileTexte3 = array("La tour est surmontée d'une flèche pyramidale, au sommet de laquelle trône une girouette d'or sous la forme de l'archange Gabriel. 
    ...
    $basilicaTexte1 = array("La Basilique Saint-Marc est l’édifice religieux le plus important de Venise. 
    ...
    $basilicaTexte2 = array("Sa construction a débuté en 828 pour abriter le corps de Saint-Marc, ramené d’Alexandrie",
    "Its construction began in 828 to house the body of Saint Mark, brought from Alexandria");
    $basilicaTexte3 = array("La basilique actuelle comporte cinq dômes et a été construite en forme de croix grecque ; elle est devenue la cathédrale de la ville en 1807. 
